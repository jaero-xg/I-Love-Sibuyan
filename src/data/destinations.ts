export type Category = 'Beaches' | 'Mountains' | 'Historical' | 'Nature' | 'Culture' | 'Adventure' | 'Hidden Gems';
...
export const categories = [
  { id: 'Beaches', label: 'Beaches', icon: '🏖', color: 'from-blue-400 to-cyan-300', image: 'https://lh3.googleusercontent.com/gps-cs-s/APNQkAEj8YUkMP30N2w9hjyrZ8QwhLLAKb6ZgMGKfugpEfK_jD6PGCvinB2roytmwSLe17qd1N2dWcc7qyJ1-BU-7abDak6R5wLYBKyS1Z3aEo0Qhj8yEiAog-7iO0Zlv1TAl3jVUnuF1g=s1360-w1360-h1020-rw' },
  { id: 'Mountains', label: 'Mountains', icon: '⛰', color: 'from-stone-500 to-stone-300', image: 'https://imgs.mongabay.com/wp-content/uploads/sites/20/2023/12/06183204/Mt-Guiting-Guiting-range-seen-from-Magdiwang-e1701888319348.png' },
  { id: 'Historical', label: 'Historical', icon: '🏛', color: 'from-amber-600 to-yellow-400', image: 'https://starliteferries.com/wp-content/uploads/2025/08/0302-Casa-Del-San-Fernando-768x507.jpg' },
  { id: 'Nature', label: 'Nature & Parks', icon: '🌿', color: 'from-green-600 to-emerald-400', image: 'https://www.journeyera.com/wp-content/uploads/2018/06/CANTINGAS-RIVER-ROMBLON-02403.jpg' },
  { id: 'Culture', label: 'Food & Culture', icon: '🎭', color: 'from-rose-500 to-pink-300', image: '' },
  { id: 'Adventure', label: 'Adventure', icon: '🧗', color: 'from-orange-600 to-red-400', image: ''},
  { id: 'Hidden Gems', label: 'Hidden Gems', icon: '💎', color: 'from-teal-500 to-cyan-400', image: '' },
];

export const regions = ['All', 'Europe', 'Asia', 'Africa', 'South America', 'Oceania', 'Middle East'];
